                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="prefixname" class="col-md-4 col-form-label text-md-right">{{ __('Prefixname') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="suffixname" class="col-md-4 col-form-label text-md-right">{{ __('Suffixname') }}</label>

                            <div class="col-md-6">
                                <select class="custom-select" id="suffixname" name="suffixname" value="{{ old('suffixname') }}">
                        ...
                        <div class="form-group row">
                            <label for="photo" class="col-md-4 col-form-label text-md-right">{{ __('Avatar') }}</label>
